...
export function MagicLinkEmail({ url, productName, email, expiresInMinutes = 5 }: MagicLinkEmailProps) {
  return (
    <NotificationLayout preview={`Your secure sign-in link for ${productName}`}>
      ...
      <Text className="mt-[24px] mb-0 text-[14px] leading-[22px] email-body text-[#1f2937]">
        For your security, don&apos;t share this link with anyone.
      </Text>

      <Text className="mt-[12px] mb-0 text-[14px] leading-[22px] email-body text-[#1f2937]">
      ...
      <Text className="mt-0 mb-0 text-[14px] leading-[22px] email-body text-[#1f2937]">The Vaster Team</Text>
    </NotificationLayout>
  )
}
